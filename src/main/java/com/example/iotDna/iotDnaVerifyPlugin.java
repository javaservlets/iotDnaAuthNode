 ...
 * @since AM 5.5.0
 */
public class iotDnaVerifyPlugin extends AbstractNodeAmPlugin {
	...
	protected Map<String, Iterable<? extends Class<? extends Node>>> getNodesByVersion() {
		return Collections.singletonMap(iotDnaVerifyPlugin.currentVersion, 
				Collections.singletonList(iotDnaVerify.class));
	}
	...
	public String getPluginVersion() {
		return iotDnaVerifyPlugin.currentVersion;
	}
}
